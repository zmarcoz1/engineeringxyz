...
const translations = {
  ...
  zh: {
    ...
    test2_author: 'Yuki Kojima',
    // 正確職稱翻譯為「工程副總裁」
    test2_role: 'Taiyo Circuit Automation 工程副總裁',
  ...
  ko: {
    ...
    // Portfolio category labels (translated to Korean)
    portfolio_category_machine: '기계 설계 프로젝트',
    portfolio_category_algorithms: '알고리즘 및 프로그래밍 프로젝트',
    portfolio_category_research: 'AI 및 소프트웨어 연구 개발 프로젝트',
  ...
  es: {
    ...
    // Etiquetas de categoría del portafolio (traducidas al español)
    portfolio_category_machine: 'Proyectos de diseño de máquinas',
    portfolio_category_algorithms: 'Proyectos de algoritmos y programación',
    portfolio_category_research: 'Proyectos de investigación y desarrollo de IA y software',
